...
function restoreOptions() {
	...
	function addNewSpace() {
		...
		appendSpace({ spaceLegend: '', id: '', name: '', accessToken: '' }, index);
	}

	const getting = browser.storage.sync.get('spaces');
...
const extensionDetails = document.querySelector('#extension-details');
extensionDetails.textContent = `${manifestData.name} v${manifestData.version}`;
